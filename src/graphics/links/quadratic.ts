...
class QuadraticLine extends LinkShapeBase {
    ...
    drawPath = (shapeLine: PIXI.Graphics, startPoint: PIXI.Point, endPoint: PIXI.Point) => {
        const ctrPoint = getControlPoint(startPoint, endPoint)
        shapeLine.moveTo(startPoint.x, startPoint.y);
        shapeLine.quadraticCurveTo(ctrPoint.x, ctrPoint.y, endPoint.x, endPoint.y);
