...
import drawBezierCurveShape from '../../../primitives/links/bezierCurveLine';
...
class CurvedLine extends LinkShapeBase{
    ...
    drawShape = () => {
        ...
        // draw path
        const shapeLine = drawBezierCurveShape({ startPoint, endPoint, ...this.data.style.shape })
        ...
        const shapeHighlightedBorder = drawBezierCurveShape({ startPoint, endPoint, ...this.data.style.states[':highlighted'].shape })
